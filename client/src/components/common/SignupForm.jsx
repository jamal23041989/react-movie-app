...
const SignupForm = ({ switchAuthState }) => {
  ...
  const signinForm = useFormik({
    initialValues: { password: '', username: '', displayName: '', confirmPassword: '' },
  ...
  return (
    <Box component="form" onSubmit={signinForm.handleSubmit}>
      ...
      <LoadingButton type="submit" fullWidth size="large" variant="contained" sx={{ marginTop: 4 }} loading={isLoginRequest}>
        sign up
      </LoadingButton>
